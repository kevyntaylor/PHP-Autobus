            ...
            <div class='row'>
                ...
                <div class='input-field col s12 l12 m12'>
                    <div class='col s12 l12 m12'>
                        <a class='modal-close waves-effect waves-light btn right' onclick='updateSeat()'>
                            <i class='material-icons center'>update</i>
                        </a>
                        <a class='modal-close waves-effect waves-light btn right' style='margin-right: 10px' onclick='removeSeat($seat)'>
